...
$controllerPath = 'http' . (empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] === 'off' ? '' : 's') . '://'
    . $_SERVER['HTTP_HOST'] . $path . 'controller.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        #signatureControlsPanel, #preview, #signButtonContainer, #fortifyContainer, #downloadButtonContainer {
            height:100%;
        }

        #preview, #signButtonContainer, #fortifyContainer, #downloadButtonContainer {
            border: 0;
            float: left;
            width: 50%;
        }
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    try {
        Promise.race([
            loadScript('https://fortifyapp.com/external/webcomponent/build/peculiar.esm.js', true),
            loadScript('https://fortifyapp.com/external/webcomponent/build/peculiar.js', false)
        ])
